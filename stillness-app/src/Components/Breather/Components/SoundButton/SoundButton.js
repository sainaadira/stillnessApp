...
const SoundButton = (props) => {
  ...
  // function to to handle the button's click and calls toggleSound() to play or pause audio depending on the state of isPlaying variable
  const handleClick = () => {
    return toggleSound()
  }

  // toggling the sound depending on the value of isPlaying and contolling the state
  const toggleSound = () => {
    if (isPlaying) {
